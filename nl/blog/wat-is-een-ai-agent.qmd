...
Hier is een onderschat probleem: LLM’s zijn sycofantisch. Omdat ze via RLHF zijn fijngeregeld om vriendelijk en behulpzaam te zijn, neigen ze ernaar te zeggen wat je wilt horen — inclusief over hun eigen plannen. Zonder ingreep maakt dit een agent overmoedig in zijn eigen slechte ideën.
...
*Dit artikel is een overzicht op hoog niveau. Latere artikelen in deze reeks gaan dieper in op specifieke componenten — RAG-architecturen, neurale herrangschikking, multi-agent-orkestratie en de trainingsdata die nodig is om deze componenten te specialiseren voor een bepaald domein.*
