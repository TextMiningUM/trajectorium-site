...
- **Sequentiële workflows worden in de verkeerde volgorde aangeleerd** — als de Fase 1/2/3-structuur niet behouden blijft, kan de fijngeregelde planningslaag van een agent leren stap 3 vóór stap 1 uit te voeren.
...
*Volgende in deze reeks: een praktische walkthrough van het chunken van een echt document en het van begin tot eind bouwen van een kleine RAG-pipeline.*
