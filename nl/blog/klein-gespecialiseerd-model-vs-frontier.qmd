...
date: 2026-10-31
author: "Jan Scholtes"
image: "https://trajectorium.ai/images/Goliath.png"
...
![](https://trajectorium.ai/images/Goliath.png){fig-align="center" style="max-width:720px;width:100%;margin:1.5rem 0;"}
...
- **Het draait lokaal, op een enkele consumentenkwaliteit GPU**, geen data verlaat het gebouw, wat direct van belang is voor het soort [institutionele en datasoevereiniteitszorgen dat eerder op deze site is behandeld](waarom-europa-eigen-ai-modellen-nodig-heeft.qmd).
...
- [Van tekst naar actie](van-tekst-naar-agentische-workflows.qmd), hoe je de trainingsdata *pipeline* bouwt die zo'n model oplevert
- [Van logboeken naar agent-trainingsdata](van-logboeken-naar-agent-trainingsdata.qmd), een concreet domeinvoorbeeld van precies dit soort gespecialiseerd trainingssignaal
- [De gigant inkrimpen: *pruning*, *quantization* en *distillation*](pruning-quantization-distillation.qmd), de complementaire compressietechnieken die kleine modellen nog kleiner en goedkoper maken
- [Waarom Europa eigen AI-modellen nodig heeft](waarom-europa-eigen-ai-modellen-nodig-heeft.qmd), waarom dit model lokaal draaien op soevereine infrastructuur ertoe doet
- [De institutionele slotgracht](de-institutionele-slotgracht.qmd), de strategische case voor specialiseren in plaats van huren
