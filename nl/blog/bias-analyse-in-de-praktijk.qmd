...
## Een noot over de wetenschappelijke bronnen

De *fairness*-maatstaven en -concepten die hier worden genoemd (demographic parity, equalized odds, equal opportunity, de spanning tussen verschillende fairness-definities, alsmede Bolukbasi et al. 2016 en Gonen & Goldberg 2019 over het ontbevooroordeeld maken van woordvectoren) komen uit een gevestigde, brede onderzoekslijn binnen *fairness in machine learning*. De Word2Vec/GloVe-voorbeelden komen direct uit een hands-on tutorial over documentrepresentatie. Voor de overige citaten heb ik in dit gesprek geen zoektoegang om exacte jaren en volledige titels te verifiëren — controleer de precieze bronnen zelf voordat je ze citeert.
