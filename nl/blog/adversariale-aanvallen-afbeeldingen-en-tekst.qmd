...
*Een noot over bronnen: verschillende specifieke aanvals- en verdedigingstechnieken die hier worden beschreven (FGSM, PGD, universele triggers, defensive distillation, feature squeezing) komen uit een goed gevestigde lijn van gepubliceerd adversarial-machine-learning-onderzoek, maar ik heb in dit gesprek geen webtooegang om elke citaat precies te verifiëren — de moeite waard om snel te controleren aan de hand van de primaire papers voordat je specifieke details zelf citeert.*
