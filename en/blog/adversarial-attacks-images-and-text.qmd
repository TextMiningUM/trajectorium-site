...
*A note on sourcing: several of the specific attack and defense techniques described here (FGSM, PGD, universal triggers, defensive distillation, feature squeezing) come from a well-established line of published adversarial-machine-learning research, but I don't have web access in this conversation to verify every citation precisely — worth a quick check against the primary papers before citing specifics yourself.*
