...
- [Shrinking the Giant: Pruning, Quantization, and Distillation](pruning-quantization-distillation.qmd) — compression as the concrete engineering path to edge and sovereign deployment
