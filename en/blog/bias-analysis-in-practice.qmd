...
## A Note on the Scientific Sources

The fairness metrics and concepts mentioned here (demographic parity, equalized odds, equal opportunity, the tension between different fairness definitions, as well as Bolukbasi et al. 2016 and Gonen & Goldberg 2019 on debiasing word embeddings) come from an established, broad line of research within fairness in machine learning. The Word2Vec/GloVe examples and the debiasing code example come directly from a hands-on tutorial on document representation. For the remaining citations, I don't have search access in this conversation to verify exact years and full titles — double-check the precise sources yourself before citing them.
